    ...
    public class QuestionRepository : IQuestionRepository
    {
        ...
        public object GetAllQuestionByTopicId(int topicId)
        {
            ...
            foreach(var question in query)
            {
                ...
                var account = _context.Accounts.SingleOrDefault(x => x.AccountId == question.AccountId);  
                ...
                questionByTopicIdDTO.accountId = account.AccountId;
                questionByTopicIdDTO.accountName = account.FullName;
